#!/usr/bin/env fish
# --8<-- [This file is automatically generated from /home/wolf/.nix-profile/etc/profile.d/nix.sh, do not edit] ---
if test -n "$HOME" ; and test -n "$USER" ;
    for d in $PATH; if test -e $d; set __savedpath $__savedpath $d; end; end;
    set -xg PATH /nix/store/68z2cvbzws1pn0z8dhgfkmws75r2z7gm-coreutils-8.29/bin
